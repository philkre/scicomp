...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    if do_ass_1
        ...
        @time "Loaded Assignment 1.1 module" begin
            @everywhere include("src/ass_1/assignment_1_1.jl")
            @everywhere using .Assignment_1_1: main as main_1_1
        end

        # Run the main function
        @info "Running main function for Assignment 1.1..."
        @time "Assigment 1.1 completed" main_1_1(; do_bench=do_bench, do_gif=do_gif, plot_output_dir=plot_output_dir)
    end
    ...
    if do_ass_2
        ...
        @time "Loaded Assignment 1.2 module" begin
            @everywhere include("src/ass_1/assignment_1_2.jl")
            @everywhere using .Assignment_1_2: main as main_1_2
        end

        # Run the main function
        @info "Running main function for Assignment 1.2..."
        @time "Assigment 1.2 completed" main_1_2(; do_bench=do_bench, do_cache=do_cache, do_gif=do_gif, plot_output_dir=plot_output_dir)
    end
    ...
    if do_ass_6
        ...
        @time "Loaded Assignment 1.6 module" begin
            @everywhere include("src/ass_1/assignment_1_6.jl")
            @everywhere using .Assignment_1_6: main as main_1_6
        end

        # Run the main function
        @info "Running main function for Assignment 1.6..."
        @time "Assigment 1.6 completed" main_1_6(; do_bench=do_bench, plot_output_dir=plot_output_dir)
    end
end